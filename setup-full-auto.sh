...
apt-get install --yes htop tmux screen vim git bash-completion software-properties-common wget gpg-agent dirmngr
...
apt-get install --yes alsa-utils atool arandr bc google-chrome-stable \
    ...
    gnome-keyring pavucontrol pasystray insync git-crypt
